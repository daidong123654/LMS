...

{
    ...
    
	{
		...
		if ($search)
		{
			...
			$this->load->view('books/category/ajax_list',$data);

		// 非 ajax 
		}
		else
		{
			$this->load->view('books/category/list',$data);		    
		}
    ...
    
	{
		...
		$this->load->view('books/category/edit',$data);
	}
	...
	{		
		...
		if (TRUE == $this->form_validation->run())
		{
			...
			$this->category_model->Avail_days = $Avail_days;
