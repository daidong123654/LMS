...
$(document).ready(function() {
  ...
  var reAdd = function(){
    window.location.href= "<?php echo site_url('news/edit')?>";
  }
...
<div id="main-tabs" class="x-tab-panel x-border-panel" style="left: 5px; top: 0px; width:100%;">
	...
	<div id="menu-body" class="x-panel-body x-panel-body-noheader x-panel-body-noborder x-border-layout-ct " >
	  ...
	  <form style="padding: 5px 5px 0pt; width: ;" class=" x-form" method="post" action="<?php echo site_url('news/save')?>"  id="form" enctype="multipart/form-data" >
	  ...
	  <div id="basic-div" class="tab-div" style="display:block">
		  ...
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">新闻标题:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <input style="width: 222px;" class="x-form-text x-form-field x-form-required" size="20"  name="title" id='title' type="text" value="<?php echo $editing['title']?>" >
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div>
		  
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">发布者:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <input style="width: 222px;" class="x-form-text x-form-field  x-form-required" size="20"  name="author" id='author' type="text" value="<?php echo $editing['author']?>" >
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div>  
		  
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">详细内容:</label>
