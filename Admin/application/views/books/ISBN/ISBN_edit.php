...
$(document).ready(function() {
  ...
  var reAdd = function(){
    window.location.href= "<?php echo site_url('ISBN/edit')?>";
  }
...
<div id="main-tabs" class="x-tab-panel x-border-panel" style="left: 5px; top: 0px; width:100%;">
	...
	<td  onClick="window.location.href='<?php echo site_url('ISBN')?>'"><table   class="x-btn-wrap x-btn x-btn-text-icon button" border="0" cellpadding="0" cellspacing="0" ><tbody><tr>
	<td class="x-btn-left"><i>&nbsp;</i></td>
	...
	<div id="menu-body" class="x-panel-body x-panel-body-noheader x-panel-body-noborder x-border-layout-ct " >
	  ...
	  <form style="padding: 5px 5px 0pt; width: ;" class=" x-form" method="post" action="<?php echo site_url('ISBN/save')?>"  id="form" enctype="multipart/form-data" >
	  ...
	  <div id="basic-div" class="tab-div" style="display:block">
		  ...
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">ISBN:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <input style="width: 222px;" class="x-form-text x-form-field x-form-required" size="20"  name="ISBN" id='ISBN' type="text" value="<?php echo $editing['ISBN']?>" >
		  </div>
		  ...
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">出版社名称:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <input style="width: 222px;" class="x-form-text x-form-field  x-form-required" size="20"  name="ISBNname" id='ISBNname' type="text" value="<?php echo $editing['ISBNname']?>" >
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div> 		
		  ...
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <input style="width: 222px;" class="x-form-text x-form-field " size="20"  name="Email" id="Email" type="text" value="<?php echo $editing['Email']?>" >
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div>
		  ...
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <input style="width: 222px;" class="x-form-text x-form-field" size="20"  name="phone" id="phone" type="text" value="<?php echo $editing['phone']?>" >
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div>
