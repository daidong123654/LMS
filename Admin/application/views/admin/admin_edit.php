 ...
 * 提交验证
 */
var userID = "<?php echo $editing['mID']?>";
...
<!--	<td><span class="ytb-sep"></span></td>
  ...
  <!-- 表单 -->
	<div id="menu-body" class="x-panel-body x-panel-body-noheader x-panel-body-noborder x-border-layout-ct " >
	 ...
	 <input name="id" id="id" type="hidden" value="<?php echo $editing['mID']?>" />
	 ...
	 <div class="x-form-item" >
		...
		<div class="x-form-element" style="padding-left: 60px;">
		 <input style="width: 222px;" class="x-form-text x-form-field x-form-required" size="20" name="name" id="name" type="text" value="<?php echo $editing['Mname']?>"  >
		</div>
	 ...
	 <div class="x-form-item" >
		...
		<div class="x-form-element" style="padding-left: 60px;">
		 <input style="width: 222px;" class="x-form-text x-form-field x-form-required x-form-email" size="20" name="email" id="email" type="text" value="<?php echo $editing['Memail']?>"  >
		</div>
		<div class="x-form-clear-left"></div>
	 </div>
