...
<div id="main-tabs" class="x-tab-panel x-border-panel" style="left: 5px; top: 0px; ">
  ...
  <div style="position: relative;"  class="x-panel-bwrap">
	  ...
	  <td onClick="window.location.href='<?php echo site_url('reader/add')?>'"><table style="width: hidden;"  class="x-btn-wrap x-btn x-btn-text-icon button" border="0" cellpadding="0" cellspacing="0"  ><tbody><tr>
