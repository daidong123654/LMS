...
$(document).ready(function() {
  ...
  var reAdd = function(){
    window.location.href= "<?php echo site_url('message/reply')?>";
  }
...
<div id="main-tabs" class="x-tab-panel x-border-panel" style="left: 5px; top: 0px; width:100%;">
	...
	<div id="menu-body" class="x-panel-body x-panel-body-noheader x-panel-body-noborder x-border-layout-ct " >
	  ...
	  <form style="padding: 5px 5px 0pt; width: ;" class=" x-form" method="post" action="<?php echo site_url('message/save_reply')?>"  id="form" enctype="multipart/form-data" >
	  ...
	  <div id="basic-div" class="tab-div" style="display:block">
		  ...
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">提问者:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <p style="width: 222px;" class="x-form-text x-form-field x-form-required" size="20"  ><?php echo $editing['username']?></p>
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div>
		  
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">提问时间:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  <p style="width: 222px;" class="x-form-text x-form-field x-form-required" size="20"  ><?php echo $editing['AskTime']?></p>
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div>
		  
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">提问内容:</label>
		  <div   style="padding-left: 80px;">		  
	      <p><?php echo $editing['content']?></p>
		  </div>
		  <div class="x-form-clear-left"></div>
	      </div> 
		  
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">回复:</label>
		  <div   style="padding-left: 80px;">
	      <?php echo $fckeditor;  ?>
		  </div>
		  <div class="x-form-clear-left"></div>
