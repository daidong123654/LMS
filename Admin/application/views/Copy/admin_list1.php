 ...
 */
// echo "<h1>admin_list.php</h1><br/>";

/*foreach ($admin_users as $value)
 {
	echo $value['Mname']."&nbsp&nbsp" ;
	echo $value['role_name']."&nbsp&nbsp" ;
	echo $value['Memail']."&nbsp&nbsp" ;
	echo $value['CreateDate']."&nbsp&nbsp<br/>" ;
 }	*/	
?>
...
<div id="main-tabs" class="x-tab-panel x-border-panel ext-ie'" style="left: 5px; top: 0px; ">
 ...
 <ul id="crt-menu2" class="x-tab-strip x-tab-strip-top" style="margin-left:0px">
 ...
 <div style="position: relative;" class="x-panel-bwrap">
   ...
   <div id="tool" class="x-panel-tbar x-panel-tbar-noheader"><div class="x-toolbar " style="border-left:0 solid #99bbe8;"><table cellspacing="0"><tbody><tr>
	 ...
	 <div class="list-div" id="listDiv" >
	     <table class="table table-striped " cellpadding="3" cellspacing="0" id="listTable" >
		 <tbody>
		 <tr class="x-grid3-header">
			...
			<th class="" >
			<div class="x-grid3-hd-inner">角色<img class="x-grid3-sort-icon" src="<?php echo base_url()?>images/s.gif"></div></th>

			<th class="" >
			<div class="x-grid3-hd-inner">Email地址<img class="x-grid3-sort-icon" src="<?php echo base_url()?>images/s.gif"></div></th>

			<th class="" >
			<div class="x-grid3-hd-inner">加入时间<img class="x-grid3-sort-icon" src="<?php echo base_url()?>images/s.gif"></div></th>

			<th class="" >
			<div class="x-grid3-hd-inner">最后登录时间<img class="x-grid3-sort-icon" src="<?php echo base_url()?>images/s.gif"></div></th>
		 ...
		 <tr class="x-grid3-row ">
			<td><div class="x-grid3-cell-inner "><?php echo $value['Mname'] ?></div></td>
			<td><div class="x-grid3-cell-inner "><?php echo $value['role_name'] ?></div></td>
			<td ><div class="x-grid3-cell-inner "><?php echo $value['Memail'] ?></div></td>
			...
			<td ><div class="x-grid3-cell-inner ">
			 ...
			 <img src="<?php echo base_url()?>images/icon_edit.gif" border="0" width="16" height="16"><i></i>
			 </a>&nbsp;&nbsp;
