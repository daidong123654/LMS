...
<div style="margin-top:-25px;background:#abc7ec;width:100%;float:left;">
	<iframe id="header-frame" scrolling="no" frameborder='0' height='4%' width="100%" name="header-frame"   src="<?php echo site_url('frameset/top') ?>"></iframe>
</div>
...
<div style="margin-top:15px;" >
	<iframe id="menu-frame" scrolling="no" frameborder='1' height="93%" width="15%" name="menu-frame"   src="<?php echo site_url('frameset/menu/books') ?>"></iframe>
	<iframe id="main-frame" scrolling="no" frameborder='1' height="93%" width="80%" name="main-frame"   src="<?php echo site_url('books') ?>"></iframe>
</div>
</body>
</html>
